...
func main(){
	...
	//if ok, _ := graph.EdgeCollectionExists(nil, "Followings"); ok {
	//	edgeCollection, _, _ = graph.EdgeCollection(nil, "Followings")
	//} else {
	//	edgeCollection, _ = graph.CreateEdgeCollection(nil, "Followings", driver.VertexConstraints{
	//		From: []string{"User"},
	//		To:   []string{"User"},
	//	})
	//}
